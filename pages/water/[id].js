    ...
    return (
      <div>
        ...
        <div style={styles.notFound}>
          ...
          <p>The water product you're looking for doesn't exist.</p>
          <Link href="/water">
            <button style={styles.backButton}>Back to Water Products</button>
          </Link>
        </div>
      </div>
    );
      ...
      <div style={styles.container}>
        ...
        <div style={styles.productMain}>
          ...
          <div style={styles.infoColumn}>
            <div style={styles.category}>💧 Still Water</div>
            ...
            <div style={styles.priceSection}>
              <div style={styles.currentPrice}>{formatZAR(product.price)}</div>
              <div style={styles.taxInfo}>incl. VAT</div>
            </div>
          ...
          <div style={styles.tabContent}>
            {activeTab === 'description' && (
              <div>
                ...
                <p>{product.description || 'Premium quality purified still water. Perfect for daily hydration.'}</p>
                <h4>Key Features:</h4>
                <ul>
                  <li>✓ Pure, refreshing taste</li>
                  <li>✓ BPA-free bottles</li>
                  <li>✓ Perfect for home, office, or on-the-go</li>
                  <li>✓ Convenient sizes available</li>
                </ul>
              </div>
            )}
            ...
            {activeTab === 'specifications' && (
              <div>
                ...
                <table style={styles.specsTable}>
                  <tbody>
                    <tr><td style={styles.specLabel}>Brand</td><td>LuChem</td></tr>
                    <tr><td style={styles.specLabel}>Water Type</td><td>Purified Still Water</td></tr>
                    <tr><td style={styles.specLabel}>Size</td><td>{product.size}</td></tr>
                    {product.volume_ml && <tr><td style={styles.specLabel}>Volume</td><td>{product.volume_ml}ml</td></tr>}
                    <tr><td style={styles.specLabel}>Bottle Material</td><td>BPA-free Plastic</td></tr>
            ...
            {activeTab === 'reviews' && (
              <div>
                ...
                <div style={styles.reviewItem}>
                  ...
                  <span>★★★★★</span>
                  <p>Great tasting water! Will order again.</p>
...
const styles = {
  ...
  unitInfo: { color: '#666', fontSize: '14px' },
